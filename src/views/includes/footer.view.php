...
<footer class="mt-auto px-10 py-10 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
    ...
    <ul class="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
        ...
        <?php if ($_SESSION['user']['loggedIn']) : ?>
            <li>
                <a href="/newHike" class="mr-4 hover:underline md:mr-6 ">Add a new Hike</a>
            </li>
            <li>
                <a href="/profile" class="mr-4 hover:underline md:mr-6 ">My Profile</a>
            </li>
            <?php if ($_SESSION['user']['is_admin']) : ?>
                <li>
                    <a href="/adminPanel" class="mr-4 hover:underline md:mr-6 ">Admin Panel</a>
                </li>
            <?php endif; ?>
            <li>
        ...
        <?php else : ?>
            ...
            <li>
                <a href="/registration" class="mr-4 hover:underline md:mr-6 ">Register</a>
            </li>
        <?php endif; ?>
    </ul>
</footer>

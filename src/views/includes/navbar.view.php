<nav class="bg-white border-gray-200 px-2 sm:px-4 px-6 py-6 rounded dark:bg-gray-900">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="/" class="flex items-center">
            <h1 class="font-bold text-xl text-gray-500">THE <span class="text-sky-400">HIKING</span> PROJECT<span class="text-sky-400">.</span></h1>
        </a>

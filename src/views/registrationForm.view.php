    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 md:h-screen">
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="flex flex-col justify-center space-y-4 md:space-y-6" action="registration" method="post">
                    <div>
                    ...
                    <button type="submit" class="flex m-auto text-white bg-sky-400 hover: bg-sky-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Register</button>
